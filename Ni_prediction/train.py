...
def readData(column = all, n=30, all_too=True, index=False, train_end=-300):
    df = pd.read_csv("Result_1.csv", index_col=0)
...
df, df_all, df_index = readData('LME_Nickel_close', n=n, train_end=train_end)
