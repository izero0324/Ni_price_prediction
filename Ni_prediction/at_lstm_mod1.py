...
def train(price_tensor, target_tensor, decoder, optimizer, criterion, num_epochs):
    ...
    for epoch in range(num_epochs):
        ...
        for ei in range(input_length):
            ...
            acc = 1-(target_tensor[ei]-decoder_output)/target_tensor[ei]
        ...
        average_loss = total_loss/(target_length+9)
        average_acc = total_acc/(target_length)
        ...
        if average_loss < best:
            ...
            save_best({'epoch':epoch,
                        ...
                        os.path.join('save_mod_0927'), 'best')
...
if __name__ == "__main__":
    ...
    resume = 'save_mod_0927/best_.pth'
    #model, optimizer, _ = load_model(model, optimizer, resume)
    model = torch.load('save_mod_0927/best_.pth')
    print(resume,'Loaded!')
